...
import "../../stylesheets/css/analyticsW3.css"
        ...
        <>
            ...
            <nav className="w3-sidebar w3-collapse w3-white w3-animate-left" style={{zIndex:"3",width:"300px"}} id="mySidebar"><br></br>
                <div class="w3-container w3-row">
                    <div class="w3-col s4">
                        <img src={YoussefPhoto} class="w3-circle w3-margin-right" style={{width:"46px", height: "50px", marginLeft:"20px"}} />
                    </div>
                    ...
                    <div class="w3-bar-block">
                        ...
                        <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  Settings</a><br></br><br></br>
                    </div>
                </div>
            </nav>
                    ...
                    <AnalyticsBox boxPerRow="4"></AnalyticsBox>
                        ...
                        <ul class="w3-ul w3-card-4 w3-white">
                                <li class="w3-padding-16">
                                    ...
                                    <span class="w3-xlarge">Mike</span><br></br>
                                </li>
                                <li class="w3-padding-16">
                                    <img src="/w3images/avatar5.png" class="w3-left w3-circle w3-margin-right" style={{width:"35px"}}/>
                                    <span class="w3-xlarge">Jill</span><br></br>
                                </li>
                                <li class="w3-padding-16">
                                    <img src="/w3images/avatar6.png" class="w3-left w3-circle w3-margin-right" style={{width:"35px"}}/>
                                    <span class="w3-xlarge">Jane</span><br></br>
                                </li>
                        </ul>
                    </div>
                    <hr></hr>
